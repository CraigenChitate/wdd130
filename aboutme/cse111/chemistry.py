...
def main ():
    ...
    chemical_formula_from_user = input("Enter the molecular formula of the sample: ")
    mass_of_chemical_from_user = float(input("Enter mass in grams of sample: "))
    ...
    element_dictionary = parse_formula(chemical_formula_from_user,periodic_table)

   

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molar_mass = round( compute_molar_mass(element_dictionary,periodic_table),5)
    print (f"{molar_mass} grams/mole")

    # Compute the number of moles in the sample.
    moles = mass_of_chemical_from_user/molar_mass
...
def make_periodic_table ():
    # these are the indexes of each element in the inner lists
    symbol_code = 0
    element_name = 1
    element_mass = 2

    #this is the compouund lists that stores other lists inside it
    periodic_table_dict = {
